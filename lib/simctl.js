...
async function teminate (udid:string, bundleId:string):void {
...
export { installApp, removeApp, launch, spawn, spawnSubProcess, openUrl, teminate, shutdown, createDevice,
