 ...
 * going to be i-plictly passed to all methods, which require it. It can either be set
 * upon instance creation if it is already knowm or later when/if needed.
 */
